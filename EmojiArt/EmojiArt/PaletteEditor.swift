...
//  EmojiArt
//
//  Created by Lee McCormick on 9/18/22.
//
...
struct PaletteEditor: View {
    // this allows to edit a Palette that's elsewhere(i.e. our Model)
    // don't care where it is...! (no Model here!)
    // u never '=' a binding, u always pass it down!
